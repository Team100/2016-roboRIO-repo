...
package org.usfirst.frc100.MichaelTestProject;
...
public class OI {
    ...
    public OI() {
        ...
        armDown = new JoystickButton(joystick1, 2);
        armDown.whileHeld(new ArmGoDown());
        armup = new JoystickButton(joystick1, 1);
        ...
        SmartDashboard.putData("ArmGoUp", new ArmGoUp());

        SmartDashboard.putData("ArmGoDown", new ArmGoDown());
