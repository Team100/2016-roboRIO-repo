...
public class UpdateDashboard extends Command {
	...
	protected void initialize() {
		...
		SmartDashboard.putString("Gear Mech/~TYPE~", "SubSystem");
		SmartDashboard.putString("Intake/~TYPE~", "SubSystem");
		SmartDashboard.putString("Pneumatics/~TYPE~", "SubSystem");
		SmartDashboard.putString("Scaling Mech/~TYPE~", "SubSystem");
	...
	protected void execute() {
		...
		Robot.knewmatics.updateDashboard();
