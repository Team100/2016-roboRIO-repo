...
public class OI {
    ...
    public JoystickButton magicMotionButton;
    ...
    public OI() {
        ...
        magicMotionButton = new JoystickButton(leftStick, 1);
        magicMotionButton.whenPressed(new MotionMagicGo());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("Drive", new Drive());
        SmartDashboard.putData("MotionMagicGo", new MotionMagicGo());
