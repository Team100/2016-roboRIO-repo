...
package org.usfirst.frc100.SyntheticDriveTrain.subsystems;
...
public class DriveTrain extends Subsystem {
    ...
    public static void TakeJoyStickInputs(Joystick JoyL, Joystick JoyR, WPI_TalonSRX right_motor, WPI_TalonSRX left_motor) {
    	right_motor.set(ControlMode.PercentOutput, JoyR.getY());
    	left_motor.set(ControlMode.PercentOutput, JoyL.getY());
