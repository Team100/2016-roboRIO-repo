...
public class OI {
    ...
    public JoystickButton raisePickupArm;
    public JoystickButton lowerPickupArm;
    ...
    public OI() {
        ...
        spinOut = new JoystickButton(operator, 1);
        spinOut.whileHeld(new RollOut());
        spinIn = new JoystickButton(operator, 1);
        spinIn.whenPressed(new RollIn());
        lowerPickupArm = new JoystickButton(operator, 1);
        lowerPickupArm.whileHeld(new LowerPickUp());
        raisePickupArm = new JoystickButton(operator, 1);
        raisePickupArm.whileHeld(new RaisePickUp());
