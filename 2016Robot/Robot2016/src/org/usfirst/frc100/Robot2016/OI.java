...
public class OI {
	...
	/*
	 * public JoystickButton flipperOutside; public JoystickButton flipperHold;
	...
	public JoystickButton forwardOrientDrive;
	...
	public OI() {
		...
		forwardOrientDrive.whenPressed(new TankDrive(true));

		backwardOrientDrive = new JoystickButton(driverController1, 4);
		backwardOrientDrive.whenPressed(new TankDrive(false));

		// SmartDashboard Buttons
		SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
		// SmartDashboard.putData("AutonomousDriveForward", new
