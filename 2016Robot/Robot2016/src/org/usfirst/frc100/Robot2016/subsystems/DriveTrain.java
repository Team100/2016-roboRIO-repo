...
public class DriveTrain extends Subsystem {
	...
	public void putPrefs(){
		Robot.prefs.putDouble("p", 0.04);
		Robot.prefs.putDouble("i", 0.0); 
		Robot.prefs.putDouble("d", 0.0);
		Robot.prefs.putDouble("gyroPidAngle", RobotMap.internalGyro.getAngle() *0.03);
	...
	public DriveTrain() {
		...
		pid = new PIDController(Robot.prefs.getDouble("p", 0.04), Robot.prefs.getDouble("i", 0), Robot.prefs.getDouble("d", 0), new PIDSource() { // .04 0 0 for 180
																// // .04 .02 0
																// for like 1
																// degree
	...
	public void drives() {
		twoMotorDrive.drive(.15, Robot.prefs.getDouble("gyroPidAngle", 0))     ;// .getAngleOfGyro());
		SmartDashboard.putNumber("heading", Robot.prefs.getDouble("gyroPidAngle", 0)); 
	}
