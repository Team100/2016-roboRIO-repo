...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1.whileHeld(new Drive());
        button3 = new JoystickButton(joystick1, 3);
        button3.whenPressed(new Home());
        button2 = new JoystickButton(joystick1, 1);
        button2.whenPressed(new goDown2());
        button1 = new JoystickButton(joystick1, 2);
        button1.whenPressed(new goUp());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("goUp", new goUp());
        SmartDashboard.putData("goDown", new goDown2());
        SmartDashboard.putData("Home", new Home());
