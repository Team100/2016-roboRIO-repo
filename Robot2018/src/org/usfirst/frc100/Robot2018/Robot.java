...
public class Robot extends TimedRobot {
    ...
    public static OI oi;
    public static Preferences prefs; //Creates preferences object Format: <Season>-<Subsystem>-<Group>-<name> ===> 2018-Lift-PIDF-kP  SEE updatePreferences.java in commands
