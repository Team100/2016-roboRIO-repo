...
public class Robot extends TimedRobot {
     ...
     */
    public static void configSettingsEncoder(WPI_TalonSRX m_motor){
    ...
    public static void configSettingsAnalog(WPI_TalonSRX m_motor){
   	 m_motor.configClosedloopRamp(0, 0);
    ...
    public void robotInit() {
        RobotMap.init();
        Preferences prefs; //Creates preferences object Format: <Season>-<Subsystem>-<Group>-<name> ===> 2018-Lift-PIDF-kP
