...
public class ClimbDown extends Command {
    ...
    protected void execute() {
    	if(RobotMap.climbingArmClimbLim1.get()||RobotMap.climbingArmClimbLim2.get()){
        	RobotMap.climbingArmClimbingTalon.set(ControlMode.PercentOutput, OI.operator.getY());
    	}else{
    		if(RobotMap.climbingArmClimbingTalon.getSelectedSensorPosition(0)> pos-5 && RobotMap.climbingArmClimbingTalon.getSelectedSensorPosition(0)< pos+5){
