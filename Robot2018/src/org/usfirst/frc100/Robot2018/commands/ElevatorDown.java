 ...
 *
 */
public class ElevatorDown extends Command {// this command will take the elevator down using the encoders on the elevator master. You lose about 20 counts every way down
