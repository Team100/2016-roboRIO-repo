...
public class ClimbUp extends Command {
    ...
    protected void execute() {
    	if(RobotMap.climbingArmClimbLim2.get()){
        	RobotMap.climbingArmClimbingTalon.set(ControlMode.PercentOutput, 0);
    	}else{
    		if(RobotMap.climbingArmClimbingTalon.getSelectedSensorPosition(0)> -5 && RobotMap.climbingArmClimbingTalon.getSelectedSensorPosition(0)< 5){
            	RobotMap.climbingArmClimbingTalon.set(ControlMode.PercentOutput, 0);
            	done = true;
    		}
    	}
