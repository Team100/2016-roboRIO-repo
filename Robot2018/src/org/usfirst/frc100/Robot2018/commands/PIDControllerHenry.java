 ...
 */
public class PIDControllerHenry implements PIDInterface, LiveWindowSendable{ //,Controller {
  ...
  private class PIDTask extends TimerTask {
    ...
    private PIDControllerHenry m_controller;

    public PIDTask(PIDControllerHenry controller) {
      if (controller == null) {
