...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.__filter_contours_min_perimeter = 75.0
    ...
    @staticmethod
    def __find_contours(i, external_only):
        ...
        im2, contours, hierarchy = cv2.findContours(i, mode=mode, method=method)
        return contours
