...
import org.usfirst.frc100.Lego_Arm_PID.commands.SyncPreferences;
import org.usfirst.frc100.Lego_Arm_PID.commands.TestPID;
...
public class OI {
    ...
    public OI() {
       ...
       button3.whenPressed(new SetArmPosition(0.372));
       
        button4 = new JoystickButton(joystick1, 4);
        button4.whenPressed(new SetArmPosition(0.491));
...
SmartDashboard.putData("PID/Test RobotArm PID", new TestPID(TestPID.System.ROBOTARM));
