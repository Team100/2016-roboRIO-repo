...
public class RobotMap {
    ...
    public static Encoder  driveTrainMotorSpeedEnc;
    ...
    public static void init() {
        ...
        driveTrainMotorSpeedEnc = new Encoder(0, 1);
        LiveWindow.addSensor("DriveTrain", "Motor Speed Enc", driveTrainMotorSpeedEnc);
