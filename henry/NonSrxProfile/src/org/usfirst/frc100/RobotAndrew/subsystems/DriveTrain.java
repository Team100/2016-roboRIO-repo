...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
    	count = 0;
    	pidVel = new PIDController(2, 0, 0, new PIDSource() { // .04 0 0 for 180
...
//pid.setPID(p, i, d);
    	pidPos = new PIDController(.5, .01 , 0, .58823, new PIDSource() { // .58823
			...
			public double pidGet() {
				return (Math.abs(RobotMap.encoderRight.getDistance()));
			}
			...
			public void pidWrite(double d) {
				...
				double output  = d;
				if(output > MotionProfile.Points[count][1]){//maxOutput MotionProfile.Points[count][1]) {
					output = MotionProfile.Points[count][1];// maxOutput MotionProfile.Points[count][1];
