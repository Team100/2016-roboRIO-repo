...
public class OI {
    ...
    public JoystickButton cancelPID;
    public JoystickButton SPath;
    ...
    public OI() {
        ...
        start.whenPressed(new FollowMotionProfile());
        ...
        SPath.whenPressed(new AutoDriveToPeg());
       // start = new 


        // SmartDashboard Buttons
      // start = new JoystickButton("Autonomous Command", new AutonomousCommand());
