...
public class  TankDrive extends Command {
    ...
    public TankDrive(double setpoint)
    {
    this.setpoint = RobotMap.internalGyro.getAngle() + setpoint;
    requires(Robot.driveTrain);
    }
    public TankDrive(int increaseing, String hi){
    	this.setpoint = RobotMap.internalGyro.getAngle() + increaseing;
    }
    public TankDrive()
    {
    	 requires(Robot.driveTrain);
    ...
    protected void execute() {
    	...
    	SmartDashboard.putNumber("number", iValue2);
